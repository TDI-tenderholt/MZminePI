...
public class RawDataFileImpl implements RawDataFile, RawDataFileWriter {
     ...
     */
    public RandomAccessFile getDataPointsFile() { return dataPointsFile; }
     ...
     */
    public int getNumOfScans() { return scans.size(); }

    /**
     * @see net.sf.mzmine.data.RawDataFile#getScan(int)
     */
    public @Nonnull
    Scan getScan(int scanNumber) { return scans.get(scanNumber); }
    ...
    public @Nonnull
    Range getDataMZRange() { return getDataMZRange(0); }
    ...
    public @Nonnull
    Range getDataRTRange() { return getDataRTRange(0); }
    ...
    public void setRTRange(int msLevel, Range rtRange) { dataRTRange.put(msLevel, rtRange); }

    public void setMZRange(int msLevel, Range mzRange) { dataMZRange.put(msLevel, mzRange); }

    public int getNumOfScans(int msLevel) { return getScanNumbers(msLevel).length; }

    public synchronized TreeMap<Integer, Long> getDataPointsOffsets() { return dataPointsOffsets; }

    public synchronized TreeMap<Integer, Integer> getDataPointsLengths() { return dataPointsLengths; }
    ...
    public @Nonnull
    String getName() { return dataFileName; }

    public void setName(@Nonnull String name) { this.dataFileName = name; }

    public String toString() { return dataFileName; }
}